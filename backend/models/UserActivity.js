...
const userActivitySchema = new mongoose.Schema(
  {
    ...
    activityType: { 
      type: String, 
      required: true,
      enum: ['file_upload', 'file_download', 'file_delete', 'data_analysis', 'chart_generation', 'chart_save', 'chart_deleted', 'data_export', 'login', 'logout', 'user_management', 'rating_submitted', 'rating_updated', 'rating_helpful']
    },
